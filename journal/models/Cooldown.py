...
class ActionCooldown(models.Model):
    """Model to represent the cooldown after claiming points for a repeatable action"""
    ...
    #Function to check whether action can be performed. Checks cooldown time.
    @staticmethod
    def can_perform_action(user, action_type, cooldown_hours=1):
        ...
        #Checking whether it has been an hour before resetting the count
