# Generated by Django 4.2.6 on 2024-04-02 02:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mood', models.CharField(choices=[('Sad', 'Sad'), ('Happy', 'Happy'), ('Angry', 'Angry'), ('Neutral', 'Neutral'), ('Excited', 'Excited'), ('Confused', 'Confused'), ('Surprised', 'Surprised'), ('Hopeful', 'Hopeful'), ('Frustrated', 'Frustrated'), ('Grateful', 'Grateful'), ('Relaxed', 'Relaxed'), ('Optimistic', 'Optimistic'), ('Anxious', 'Anxious')], max_length=20, verbose_name='Mood')),
