# Generated by Django 4.2.6 on 2024-04-01 13:35
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    django_ckeditor_5.fields.CKEditor5Field(
                        max_length=10000, verbose_name="Entry"
                    ),
                ),
                (
                    "owner",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "summary",
                    models.TextField(max_length=350, verbose_name="Description"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content",
                    django_ckeditor_5.fields.CKEditor5Field(
                        max_length=10000, verbose_name="Entry Content"
                    ),
                ),
                ("entry_date", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, through="journal.Friendship", to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.AddField(
            model_name="user",
            name="groups",
            field=models.ManyToManyField(
                through="journal.GroupMembership", to="journal.group"
            ),
        ),
        migrations.AddField(
            model_name="user",
